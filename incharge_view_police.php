...
<head>
     ...
     if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $q1="delete from police where p_id='$pid'";
            $rs = $conn->query($q1);
            $q3="update complaint set pol_status='null',inc_status='Unassigned',p_id='Null' where p_id='$pid'";
            $rs = $conn->query($q3);
          }
    }
    
    
    $query1="select p_id,p_name,spec,location from police where location='$location'";  
