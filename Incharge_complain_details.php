...
<head>
    ...
    $query1="select c_id,type_crime,d_o_c,description from complaint where c_id='$cid' and location='$location'";
    ...
    if(isset($_POST['assign']))
    {
      if($_SERVER["REQUEST_METHOD"]=="POST")
      {
        ...
        $res1="SELECT p_id FROM police where p_name='$pname'";
          $rs = $conn->query($res1);
          $num = $rs->num_rows;
          $q3 =$rs->fetch_assoc();  
           $pid=$q3['p_id'];
        ...
        $res="update complaint set inc_status='Assigned',pol_status='In Process',p_id='$pid' where c_id='$cid'";
          $rs = $conn->query($res);
...
<body>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php"><b>Crime-Management Portal</b></a>
    </div>
...
<select class="form-control" name="police_name" style="margin-left:40%; width:250px;">
            <?php
                        $p_name="select p_name from police where location='$location'";
                        $rs2= $conn->query($p_name);
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime-Management Portal 2020</b></h4>
</div>
