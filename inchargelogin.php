...
if(isset($_POST['s']))
{
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        $name=$_POST['email'];
        $pass=$_POST['password'];
        $query="SELECT i_id,i_pass FROM police_station where i_id='$name' and i_pass='$pass' ";
        $rs = $conn->query($query);
        $_SESSION['email']=$name;
...
<body style="color: black;background-image: url(incharge1.jpg);background-size: 100%;background-repeat: no-repeat;back">
