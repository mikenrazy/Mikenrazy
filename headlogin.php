   ...
   include 'includes/config.php';
    {
        $name=$_POST['email'];
        $pass=$_POST['password'];
        $query="SELECT h_id,h_pass FROM head where h_id='$name' and h_pass='$pass' ";
        $rs = $conn->query($query);
...
<body style="color: black;background-image: url(policestation.jpg);background-size: cover;background-position: center;background-repeat: no-repeat;back">
