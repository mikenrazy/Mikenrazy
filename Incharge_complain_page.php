...
<head>
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $_SESSION['cid']=$cid;
        $query1="select inc_status,location from complaint where c_id='$cid'";
        $rs1 = $conn->query($query1);
        $num = $rs1->num_rows;
        $rows =$rs1->fetch_assoc(); 
        
        $inc_st=$rows['inc_status'];
        $loc=$rows['location'];
    ...
    $query2="select c_id,type_crime,d_o_c,location,inc_status,p_id from complaint where location='$location' order by c_id desc";
...
<body style="background-color: #dfdfdf">
 ...
 <div style="padding:50px;">
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime-Management Portal 2020 | All Right Reserved</b></h4>
</div>
