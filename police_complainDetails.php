...
<head>
    ...
    if(isset($_POST['status'])){
        ...
        {
            $upd=$_POST['update'];
            $qu1="insert into update_case(c_id,case_update) values('$cid','$upd')";
            $rs1=$conn->query($qu1);  
          }
    }
    ...
    if(isset($_POST['close'])){
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $qu2="insert into update_case(c_id,case_update) values('$cid','$up')";
            $rs2=$conn->query($qu2);  
            $qu3="update complaint set pol_status='ChargeSheet Filed' where c_id='$cid'";
            $rs3=$conn->query($qu3);  
        }
    }
     $res2="select d_o_u,case_update from update_case where c_id='$cid'";
      $rs4=$conn->query($res2);  
    ?>
